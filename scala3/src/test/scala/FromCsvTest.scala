import com.github.gekomad.ittocsv.core.FromCsv.{list2Product, Decoder}
...
class FromCsvTest extends munit.FunSuite:
  ...
  test("tokenizeCsvLine_to_types_ok") {
  ...
  test("tokenizeCsvLine_to_types_boolean_ko") {
  ...
  test("tokenizeCsvLine_to_types_Option_Double__ko") {
  ...
  test("from_csv_email_with_custom_parser") {
  ...
  test("from_csv_url_with_custom_parser") {
    import com.github.gekomad.ittocsv.core.FromCsv.*
    given IttoCSVFormat = IttoCSVFormat.default
  ...
  test("tokenizeCsvLine_to_types_complete") {
  ...
  test("list_of_csv_string_to_list_of_type") {
    import com.github.gekomad.ittocsv.core.FromCsv.*
    import com.github.gekomad.ittocsv.parser.IttoCSVFormat
    final case class Foo(a: Int, b: Double, c: String, d: Boolean)
    given IttoCSVFormat = IttoCSVFormat.default
  ...
  test("list_of_csv_string_to_list_of_type_with_empty_string_and_ignoreEmptyLines_false") {
  ...
  test("list_of_csv_string_to_list_of_type_with_empty_string_and_ignoreEmptyLines_true") {
    import com.github.gekomad.ittocsv.core.FromCsv.*
    import com.github.gekomad.ittocsv.parser.IttoCSVFormat
    final case class Foo(a: Int)
  ...
  test("CSVtoListOftTypeWithCustomLocalDateTime") {
    import com.github.gekomad.ittocsv.core.FromCsv.*
    ...
    given Decoder[String, LocalDateTime] = { s =>
      scala.util
        .Try {
  ...
  test("decode_custom_option_LocalDateTime") {
    import com.github.gekomad.ittocsv.core.FromCsv.*
    import com.github.gekomad.ittocsv.parser.IttoCSVFormat
